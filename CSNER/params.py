...
# *nix style dir
#parameters['base'] = "/mnt/c/Users/Lucius/OneDrive/MSAI/SourceCodes/Python/NER"
#parameters['train'] = os.path.join(parameters['base'], "data/eng.train") #Path to train file
#parameters['dev'] = os.path.join(parameters['base'], "data/eng.testa") #Path to test file
#parameters['test'] = os.path.join(parameters['base'], "data/eng.testb") #Path to dev file
#parameters['embedding_path'] = "/mnt/d/Dev/Vector/glove.6B.100d.txt" #Location of pretrained embeddings
...
parameters['name'] = "self-trained-model_NoCRF_LSTM_CNN_Char" # Model name
parameters['gradient_clip'] = 5.0
parameters['char_mode'] = "LSTM"
parameters['start_type'] = "cold"
parameters['cnn_layers'] = 3
